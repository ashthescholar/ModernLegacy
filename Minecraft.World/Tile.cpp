...
// fletch added: modern blocks definition
	Tile::deepslate = (new Tile(180, Material::stone))										->setDestroyTime(1.5f)->setExplodeable(10)->setSoundType(Tile::SOUND_STONE)->setIconName(L"Deepslate")->setDescriptionId(IDS_TILE_DEEPSLATE)->setUseDescriptionId(IDS_DESC_DEEPSLATE);
